import { CadastroComponent } from './pages/boletim/cadastro/cadastro.component';
...
import { ListaComponent } from './pages/boletim/lista/lista.component';

export const routes: Routes = [
    {
        path: '', 
        component: PagesComponent, children: [
            { path: '', component: ListaComponent, data: { breadcrumb: 'Lista' } },
            ...
            { path: 'consulta', component: ListaComponent, data: { breadcrumb: 'Consulta' } },
        ],
